...
<div class="newsvine-vid">
    ...
    <div data-role="collapsible" data-inset="false" data-collapsed="false">
        ...
        <ul data-role="listview">
            ...
            <li>
                <a href="#<?php echo $id;?>_popup_map" data-transition="turn" data-rel="popup" class="ui-btn ui-icon-location ui-btn-icon-notext ui-corner-all ui-btn-inline nwsv_map_latlng">location</a>
                <div data-role="popup" id="<?php echo $id;?>_popup_map" data-overlay-theme="a" data-theme="a" data-corners="false" data-tolerance="15,15">
