...
<div class="newsvine-vid">
    ...
    <div data-role="collapsible" data-inset="false" data-collapsed="false">
        ...
        <ul data-role="listview">
            ...
            <li>
                <a href="#popupMap" class="nwsv_map_latlng" data-transition="turn" data-rel="popup" class="ui-btn ui-icon-location ui-btn-icon-notext ui-corner-all ui-btn-inline"><?php echo $location; ?></a>
